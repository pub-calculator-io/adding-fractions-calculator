...
Version: 1.0.0
Author: Adding Fractions Calculator / www.calculator.io
...
function display_calcio_ci_adding_fractions_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_adding_fractions_calculator', 'display_calcio_ci_adding_fractions_calculator' );